...
parser.add_option("-r", "--ratios_output", type="str", dest="ratios_output", default='CuDPPE_15_laser_01__ratios.h5',
                  help="output hdf5 file name for all ratios")
parser.add_option("-R", "--ratios_txt_output", type="str", dest="ratios_txt_output", default='CuDPPE_15_laser_01__ratios.txt',
                  help="output txt file name for all ratios")
parser.add_option("-o", "--output", type="str", dest="output", default='CuDPPE_15_laser_01__ratios.hkl',
...
parser.add_option("-n", "--min_n", type="int", dest="min_n", default=6,
